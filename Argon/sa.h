...
void make_temp()
{
    ...
    std::string sigma_rep = "sed -i 's/SSSSSSSSS/" + stream.str() 
      + "/g' temp_100/Liq/Par_Vrabec01_Noble_Gases_Exotic.inp";
    system(sigma_rep.c_str());
    sigma_rep = "sed -i 's/SSSSSSSSS/" + stream.str() 
...
double objective_function()
{
    ...
    system("cd temp_100/Vap; ./GOMC_GPU_NPT in.conf > out.log");
    ...
    system("cd temp_130/Liq; ./GOMC_GPU_NPT in.conf > out.log");
    ...
    system("cd temp_130/Vap; ./GOMC_GPU_NPT in.conf > out.log");
